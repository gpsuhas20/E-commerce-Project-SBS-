...
{ const[data2,setdata2]=useState(false)
    ...
    const [isSuccessOpen7 , setSuccessOpen7] = useState(false);
    function toggleSuccessModal7(prevState) {
        setSuccessOpen7(!isSuccessOpen7)
    } 
...
var data1=data
  ...
  console.log(data)
   ...
   if(logintype)
    ...
    {return(
        ...
        <div className="container">
            <Modal className='success-modal ' isOpen = {isSuccessOpen3} toggle={toggleSuccessModal3}>
                    <ModalHeader toggle={toggleSuccessModal3} className='success-modal-text text-center'><p style={{textAlign:"center"}}> <strong>SCAN TO PAY</strong></p> </ModalHeader>
                    <ModalBody>
        ...
        <div className="container">
    <Modal className='success-modal modal-width' isOpen = {isSuccessOpen4} toggle={toggleSuccessModal4}>
    ...
    <Modal className='success-modal' isOpen = {isSuccessOpen5} toggle={toggleSuccessModal5}>
            <ModalHeader toggle={toggleSuccessModal5} className='success-modal-text '> <p><strong> Sorry</strong></p> </ModalHeader>
            <ModalBody>
    ...
    <div className="container align-middle">
            <Modal className='success-modal modal-width' isOpen = {isSuccessOpen7} toggle={toggleSuccessModal7}>
  ...
  <div className="row justify-content-center">
    ...
    <Menu className="sidebar" isOpen={ isOpen } customBurgerIcon={false}>
       ...
       <div className="col-12 container"><a href ='/feedback'className="menu-item row"><span className="fa fa-comments fa-lg offset-1 offset-sm-2 offset-lg-2 col-1 p-1"></span><span className="offset-1 offset-sm-2 col-7 col-sm-6"> FeedBack</span></a></div> 
            ...
            <div className="row row-content">
                ...
                <div className="allpageheader">
                    ...
                    <div className="payform flex-container">
                        ...
                        <br></br>                   
                         <input type="radio" id="creditcard" name="radio" value="creditcard" disabled/>                           
                            <img src="/images/creditcard.png" className="payicons" alt="payicons"></img>                           
                            <label for="creditcard">Credit Card</label><br></br>                                                                            
                        <br></br>                       
                            <input type="radio" id="debitcard" name="radio" value="debitcard" disabled/>
