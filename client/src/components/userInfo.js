...

{
    ...
    function submitHandler(e) {
        ...
        toggleSuccessModal1()
         ...
         const d = await axios.put(`${baseurl}/users/address`,config)
        setAddress(d.address)
       toggleSuccessModal1()
        window.location.reload(false)
  ...
  <div className="row justify-content-center">
    <strong>Updating Address</strong>
  </div>
</div>           
...
<div className="row">
    ...
    else
    {
        if(logintype)
        {
            return(   <div className="container-fluid align-middle spinner">
            <div className="row justify-content-center">
              <div className="spinner-border" role="status">
                   <span class="sr-only">Loading...</span>
              </div>
            ...
            <div className="row justify-content-center">
              <strong>Getting your Info!!</strong>
            </div>
          </div>          )
        }
        return(
