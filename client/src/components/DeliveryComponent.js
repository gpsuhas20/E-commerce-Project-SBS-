...
import React, { useState,useEffect}  from 'react';
import { Link } from 'react-router-dom';
import {Accordion, Button, ButtonGroup, Card, ToggleButtonm} from 'react-bootstrap'
        ...
        <>
          <div className="container">
            <Modal className='success-modal  modal-width' isOpen = {isSuccessOpen1} toggle={toggleSuccessModal1}>
                    <ModalHeader toggle={toggleSuccessModal1} className='success-modal-text '> <strong>Oops!!</strong> </ModalHeader>
                    <ModalBody>
                        
                            <p style={{textAlign:"center"}}>Please Select Delivery Slot!</p>                                
                        ...
                        <Accordion defaultActiveKey="0">
                            <Card style={{height:"120px"}}>
                                ...
                                <Accordion eventKey="0">
                                    ...
                                    <Button className="paccButton1" onClick={()=>{setdate(n1)
                                    setRadioValue("12PM-2PM")
                                setsel(true)} 
                            ...
                            <Card style={{height:"120px"}}>
                                ...
                                <Accordion eventKey="1">
                                    ...
                                    <Button className="paccButton1" onClick={()=>{setdate(n2)
                                    setRadioValue("12PM-2PM")
                                    setsel(true)} 
                            ...
                            <Card style={{height:"120px"}}>
                                    ...
                                    <Accordion as={Card.Header} eventKey="2" className="plinkcolor paccCard">
                                        {n3}
                                    </Accordion>
                                ...
                                <Accordion eventKey="2">
                                    ...
                                    <Button className="paccButton1" onClick={()=>{setdate(n3)
                                    setRadioValue("12PM-2PM")
                                    setsel(true)} 
                            ...
                            <Card style={{height:"120px"}}>
                                    ...
                                    <Accordion as={Card.Header} eventKey="3" className="plinkcolor paccCard">
                                        {n4}
                                    </Accordion>
                                
                                <Accordion eventKey="3">
                                    <Card.Body className="paccCardBody">
                                    <Button className="paccButton1" onClick={()=>{setdate(n4)
                                    setRadioValue("12PM-2PM")
                                    setsel(true)
                                } 
