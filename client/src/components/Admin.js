...
if(data)
    ...
    <div className="container  text-align-center">
      <div className="row justify-content-center">
        ...
        <div className=" offset-1   col-7  offset-md-0 col-md-3">
          <a href="/employee" className="btn  btn-danger  admin-btn p-1 btn-block">
            <i className="fa fa-users"></i> Employees
          </a>
        </div>
        <div className=" offset-1   col-7  offset-md-0 col-md-3">
        <a href="/adminfeedback" className="btn  btn-info  admin-btn p-1 btn-block">
  ...
  <div className="container  text-align-center">
    <div className="row justify-content-center">
      ...
      <div className=" offset-1   col-7  offset-md-0 col-md-3">
        ...
        <div className=" offset-1   col-7  offset-md-0 col-md-3">
        <a href="/adminfeedback" className="btn  btn-info  admin-btn p-1 btn-block">
          <i className="fa fa-users"></i> Feedback
        </a>
      </div>
    </div>
  </div>
